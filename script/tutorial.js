    ...
    btn.addEventListener('click', function(e) {
      ...
      const languageDict = {
        'german_lang': {
          ...
          'example_text': 'Am nächsten Morgen <span class="bewegung-subjekt">schrieb</span> Laura mit <span class="dimensionierung-groesse">großen</span> steifen Buchstaben Name und Wohnung des Herrn Hahn <span class="richtung">auf</span> einen <span class="ort-objekt-bk">Briefumschlag</span>, <span class="bewegung-subjekt">siegelte</span> diesen mit einem Veilchen, welches die Umschrift trug: »ich verberge mich,« und <span class="bewegung-subjekt">steckte</span> die Adresse <span class="richtung">in</span> ihre <span class="ort-objekt-bk">Tasche</span>. Als sie wegen eines Einkaufs <span class="richtung">nach</span> der <span class="ort-container-bk">Stadt</span> <span class="bewegung-subjekt">ging</span>, machte sie auf eigene Gefahr einen Seitenweg <span class="richtung">zu</span> einem Handelsgärtner, mit dem sie persönlich nicht bekannt war. <span class="positionierung">Dort</span> kaufte sie den <span class="dimensionierung-groesse">dicken</span> Busch einer Zwergorange <span class="dimensionierung-menge">voll von</span> Blüthen und goldenen Früchten, ein Prachtstück des Glashauses, sie <span class="bewegung-subjekt">fuhr</span> den Strauch mit pochendem Herzen <span class="positionierung">in</span> <span class="bewegung-subjekt">geschlossener</span> <span class="ort-container">Droschke</span>, bis sie einen Lohnträger <span class="bewegung-subjekt">fand</span>, und <span class="bewegung-schall">empfahl</span> mit einer außerordentlichen Vergütigung dem <span class="ort-objekt-bk">Träger</span>, Strauch und Brief ohne Gruß und Wort <span class="positionierung">im</span> <span class="ort-container">Hause</span> des Herrn Hahn <span class="bewegung-subjekt">niederzusetzen</span>.',
        ...
        'english_lang': {
          ...
          'annotation_classes_infos': [
            [
              ...
              <li>For a movement context to exist, there must be an annotated movement in the co-text (»<span class='inline-examples'>to <span class='w3-tag'>run</span></span> into the forest«).</li>
              ...
              `
              <li>Objects have spatial dimensions, but are not containers in which human characters can prototypically reside.</li>
              <li><b>With the class <i>PLACE-OBJECT-MC</i> we annotate, in contrast to the class <i>PLACE-OBJECT</i>, all types of objects</b> that are the unmoved destination and starting point of directed movements in a <b>movement context (MC)</b> (»to move towards <span class='inline-examples'>the <span class='w3-tag'>painting</span></span>«).</li>
              <li>For a movement context to exist, there must be an annotated movement in the co-text (»<span class='inline-examples'>to <span class='w3-tag'>move</span></span> towards the painting«).</li>
              <li>A movement can also be a perception or something else: See the information on the movement category.</li>
              ...
              <li>For a movement context to exist, there must be an annotated movement in the co-text (»<span class='inline-examples'>to <span class='w3-tag'>run</span></span> to the said site«).</li>
              <li>A movement can also be a perception or something else: See the information on the movement category.</li>
              <li>Each annotated abstract must be located in a container in which human characters can prototypically reside.</li>
              `,
              `
              ...
              <li>The transferred use can be creative-metaphorical: »There, out of <span class='inline-examples'>deep <span class='w3-tag'>darkness</span></span> shines the burning candle.«</li>
              ...
              <li>The transferred use can be creative-metaphorical: »Disappear behind a <span class='inline-examples'>cloud, <span class='w3-tag'>Moon</span></span>, I prefer the company of my professor!«</li>
              <li>It can be idiomatic-metonymic: »she makes <span class='inline-examples'>a <span class='w3-tag'>side path</span></span> to the library«.</li>
              `
            ],
            [
              `
          ...
          'example_text': 'The next morning Laura <span class="bewegung-subjekt">wrote</span> Mr. Hahn`s name and address <span class="richtung">on</span> an <span class="ort-objekt-bk">envelope</span> in <span class="dimensionierung-groesse">large</span>, stiff letters, <span class="bewegung-subjekt">sealed</span> it with a violet bearing the inscription, “I am hiding,” and <span class="bewegung-subjekt">put</span> the address <span class="richtung">in</span> her <span class="ort-objekt-bk">pocket</span>. When she <span class="bewegung-subjekt">went</span> <span class="richtung">into</span> <span class="ort-container-bk">town</span> to do some shopping, she took a side street at her own risk <span class="richtung">to</span> a market gardener she was not personally acquainted with. <span class="positionierung">There</span> she bought a <span class="dimensionierung-groesse">thick</span> bush of dwarf oranges, <span class="dimensionierung-menge">full of</span> flowers and golden fruit, a real showpiece of the greenhouse. She <span class="bewegung-subjekt">drove</span> the bush with a pounding heart <span class="positionierung">in</span> a <span class="bewegung-subjekt">closed</span> <span class="ort-container">cab</span>, until she <span class="bewegung-subjekt">found</span> a laborer, and with an extraordinary sum she <span class="bewegung-schall">recommended</span> that the <span class="ort-objekt-bk">laborer</span> should <span class="bewegung-subjekt">put down</span> the bush and letter <span class="positionierung">inside</span> the <span class="ort-container">house</span> of Mr. Hahn without a word or greeting.',
