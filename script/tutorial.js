  ...
  'german_lang': {
    ...
    'annotation_classes_infos': [
      [
        ...
        `,
        `
        <li><i>ALT</i> steht für <i>alternative Verwendung</i>.</li>
        <li>Es markiert einen an der Textstelle nicht nach den Hauptklassen annotierbaren Ausdruck, der an anderer Stelle aber annotierbar ist, also eine nach den Hauptklassen räumliche Bedeutung haben kann.</li>
        <li>Der Ausdruck oder der Kopf des Kompositums muss nach den Informationen eines Wörterbuchs (für das Deutsche: <a href='https://www.dwds.de/wb' target='_blank'>DWDS</a>) im kontemporären Sprachgebrauch räumlich im Sinne eines Ortes verwendet werden können, also als Bezeichnung für einen Container, ein geografisches, astronomisches oder raumstrukturelles Objekt oder Abstraktum.</li>
        <li>»Sie verirrte sich in <span class='inline-examples'>ihrem <span class='w3-tag'>Gedankenpalast</span></span>.«</li>
        <li>»Haben sich die Leute aus Berlin schon gemeldet? - <span class='inline-examples'>Ja, <span class='w3-tag'>Berlin</span></span> hat abgesagt.«</li>
        <li>»Ein günstiger Zufall führte auf <span class='inline-examples'>dieser <span class='w3-tag'>Spur</span></span> zum gesuchten Buch.«</li>
        <li>»das <span class='inline-examples'>Flavische <span class='w3-tag'>Kaiserhaus</span></span>«.</li>
        <li>»sie macht <span class='inline-examples'>einen <span class='w3-tag'>Seitenweg</span></span> zur Bibliothek«.</li>
        `,
        `
        ...
        <li>Die Übertragung kann kreativ-metaphorisch sein: »Sie verirrte sich in <span class='inline-examples'>ihrem <span class='w3-tag w3-grey w3-text-grey'>Gedankenpalast</span></span>.«</li>
        <li>Sie kann kreativ-metonymisch sein: »Haben sich die Leute aus Berlin schon gemeldet? - <span class='inline-examples'>Ja, <span class='w3-tag w3-grey w3-text-grey'>Berlin</span></span> hat abgesagt.«</li>
        <li>Sie kann idiomatisch-metaphorisch sein: »Ein günstiger Zufall führte auf <span class='inline-examples'>dieser <span class='w3-tag w3-grey w3-text-grey'>Spur</span></span> zum gesuchten Buch.«</li>
        <li>Sie kann idiomatisch-metonymisch sein: »das <span class='inline-examples'>Flavische <span class='w3-tag w3-grey w3-text-grey'>Kaiserhaus</span></span>«.</li>
        `,
        `
        <li class='w3-text-black'><b>Diese Klasse wird im CANSpiN-Projekt seit CS1 v1.1.0 nicht mehr berücksichtigt.</b></li>
        <li><i>UE</i> steht für <i>Übertragung</i>.</li>
      ...
      [
        ...
        <li><i>ALT</i> steht für <i>alternative Verwendung</i>.</li>
        <li>Es markiert einen an der Textstelle nicht nach den Hauptklassen annotierbaren Ausdruck, der an anderer Stelle aber annotierbar ist, also eine nach den Hauptklassen räumliche Bedeutung haben kann.</li>
        <li>Der Ausdruck muss nach den Informationen eines Wörterbuchs (für das Deutsche: <a href='https://www.dwds.de/wb' target='_blank'>DWDS</a>) im kontemporären Sprachgebrauch räumlich im Sinne einer Bewegung verwendet werden können, also als Bezeichnung für die Bewegung von Subjekten, Objekten, von Licht, Schall und Geruch oder deren Wahrnehmung.</li>
        <li>»Der <span class='inline-examples'>Mond <span class='w3-tag'>sang</span></span> mir das Lied meiner Kindheit.«</li>
        <li>»Der <span class='inline-examples'>Anblick <span class='w3-tag'>brachte</span></span> mir die Situation von damals in Erinnerung.«</li>
        <li>»<span class='inline-examples'>Das <span class='w3-tag'>klingt</span></span> wie der Titel eines Action-Films.«</li>
        <li>»Dieser <span class='inline-examples'>Weg <span class='w3-tag'>führt</span></span> bis zu den Toren der Stadt.«</li>
        `,
        `
        <li class='w3-text-white'><b>Diese Klasse wird im CANSpiN-Projekt seit CS1 v1.1.0 nicht mehr berücksichtigt.</b></li>
        <li><i>UE</i> steht für <i>Übertragung</i>.</li>
        <li><i>UE-RX</i> ist ein übertragender Gebrauch von räumlichem Vokabular (räumlicher Quellbereich: R) für den Ausdruck nicht-räumlicher Sachverhalte (nicht-räumlicher Zielbereich: X).</li>
        <li>Die Übertragung kann kreativ-metaphorisch sein: »Der <span class='inline-examples'>Mond <span class='w3-tag w3-grey w3-text-grey'>sang</span></span> mir das Lied meiner Kindheit.«</li>
        <li>Sie kann idiomatisch-metaphorisch sein: »Der <span class='inline-examples'>Anblick <span class='w3-tag w3-grey w3-text-grey'>brachte</span></span> mir die Situation von damals in Erinnerung.«</li>
        <li>Sie kann idiomatisch-metonymisch sein: »<span class='inline-examples'>Das <span class='w3-tag w3-grey w3-text-grey'>klingt</span></span> wie der Titel eines Action-Films.«</li>
        `,
        `
        <li class='w3-text-white'><b>Diese Klasse wird im CANSpiN-Projekt seit CS1 v1.1.0 nicht mehr berücksichtigt.</b></li>
        <li><i>UE</i> steht für <i>Übertragung</i>.</li>
      ...
      [
        ...
        <li><i>ALT</i> steht für <i>alternative Verwendung</i>.</li>
        <li>Es markiert einen an der Textstelle nicht nach den Hauptklassen annotierbaren Ausdruck, der an anderer Stelle aber annotierbar ist, also eine nach den Hauptklassen räumliche Bedeutung haben kann.</li>
        <li>Der Ausdruck muss nach den Informationen eines Wörterbuchs (für das Deutsche: <a href='https://www.dwds.de/wb' target='_blank'>DWDS</a>) im kontemporären Sprachgebrauch räumlich im Sinne einer Dimensionierung verwendet werden können, also als Ausdruck für eine räumliche Größe oder einen Abstand.</li>
        <li>Mengenangaben funktionieren im Gegensatz zu Größen- und Abstandsangaben nur räumlich mit Bezug auf eine räumliche Entität: Bezieht sich eine Mengenangabe auf etwas nicht-räumliches, wird dies entsprechend nicht als alternative Verwendung annotiert.</li>
        <li>»Das <span class='inline-examples'>waren <span class='w3-tag'>höchst</span></span> unerfreuliche Nachrichten.«</li>
        `,
        `
        <li class='w3-text-black'><b>Diese Klasse wird im CANSpiN-Projekt seit CS1 v1.1.0 nicht mehr berücksichtigt.</b></li>
        <li><i>UE</i> steht für <i>Übertragung</i>.</li>
        ...
        <li>Die Übertragung kann idiomatisch-metaphorisch sein: »Das <span class='inline-examples'>waren <span class='w3-tag w3-grey w3-text-grey'>höchst</span></span> unerfreuliche Nachrichten.«</li>
        `,
        `
        <li class='w3-text-black'><b>Diese Klasse wird im CANSpiN-Projekt seit CS1 v1.1.0 nicht mehr berücksichtigt.</b></li>
        <li><i>UE</i> steht für <i>Übertragung</i>.</li>
      ...
      [
        ...
        <li><i>ALT</i> steht für <i>alternative Verwendung</i>.</li>
        <li>Es markiert einen an der Textstelle nicht nach den Hauptklassen annotierbaren Ausdruck, der an anderer Stelle aber annotierbar ist, also eine nach den Hauptklassen räumliche Bedeutung haben kann.</li>
        <li>Der Ausdruck muss Teil einer Phrase sein, an der Inhaltswörter der Kategorien Ort, Bewegung oder Dimensionierung beteiligt sind, die in der Phrase alternativ verwendet werden.</li>
        <li>»<span class='inline-examples'><span class='w3-tag'>an</span></span> dem silbernen Schilde der Wahrheit <b>zerschellen</b>«.</li>
        <li>»es <b>nagt</b> mancher <span class='inline-examples'>Kummer <span class='w3-tag'>am</span></span> Herzen«.</li>
        `,
        `
        <li class='w3-text-black'><b>Klasse wird im CANSpiN-Projekt seit CS1 v1.1.0 nicht mehr berücksichtigt.</b></li>
        <li><i>UE</i> steht für <i>Übertragung</i>.</li>
        <li><i>UE-RX</i> ist ein übertragender Gebrauch von räumlichem Vokabular (räumlicher Quellbereich: R) für den Ausdruck nicht-räumlicher Sachverhalte (nicht-räumlicher Zielbereich: X).</li>
        <li>Der Ausdruck muss Teil einer Übertragungsphrase sein, an der Inhaltswörter der Kategorien Ort, Bewegung oder Dimensionierung beteiligt sind, oder etymologisch sich gesichert aus einer räumlichen Verwendungsweise entwickelt haben.</li>
        <li>Die Übertragung kann idiomatisch-metaphorisch sein: »<span class='inline-examples'><span class='w3-tag w3-grey w3-text-grey'>an</span></span> dem silbernen Schilde der Wahrheit <b>zerschellen</b>«, »es <b>nagt</b> mancher <span class='inline-examples'>Kummer <span class='w3-tag w3-grey w3-text-grey'>am</span></span> Herzen«.</li>
        `,
        `
        <li class='w3-text-black'><b>Klasse wird im CANSpiN-Projekt seit CS1 v1.1.0 nicht mehr berücksichtigt.</b></li>
        <li><i>UE</i> steht für <i>Übertragung</i>.</li>
      ...
      [
        ...
        <li>Es markiert einen an der Textstelle nicht nach den Hauptklassen annotierbaren Ausdruck, der an anderer Stelle aber annotierbar ist, also eine nach den Hauptklassen räumliche Bedeutung haben kann.</li>
        <li>Der Ausdruck muss Teil einer Phrase sein, an der Inhaltswörter der Kategorien Ort, Bewegung oder Dimensionierung beteiligt sind, die in der Phrase alternativ verwendet werden.</li>
        <li>»Manchmal kann <span class='inline-examples'>man <span class='w3-tag'>aus</span></span> dem Rhythmus <b>geraten</b>.«</li>
        <li>»Dieser Weg <span class='inline-examples'><b>führt</b> <span class='w3-tag'>bis</span></span> <span class='inline-examples'><span class='w3-tag'>zu</span></span> den Toren der Stadt.«</li>
        `,
        `
        <li class='w3-text-black'><b>Diese Klasse wird im CANSpiN-Projekt seit CS1 v1.1.0 nicht mehr berücksichtigt.</b></li>
        <li><i>UE</i> steht für <i>Übertragung</i>.</li>
        <li><i>UE-RX</i> ist ein übertragender Gebrauch von räumlichem Vokabular (räumlicher Quellbereich: R) für den Ausdruck nicht-räumlicher Sachverhalte (nicht-räumlicher Zielbereich: X).</li>
        <li>Der Ausdruck muss Teil einer Übertragungsphrase sein, an der Inhaltswörter der Kategorien Ort, Bewegung oder Dimensionierung beteiligt sind, oder etymologisch sich gesichert aus einer räumlichen Verwendungsweise entwickelt haben.</li>
        <li>Die Übertragung kann idiomatisch-metaphorisch sein: »Manchmal kann <span class='inline-examples'>man <span class='w3-tag w3-grey w3-text-grey'>aus</span></span> dem Rhythmus <b>geraten</b>.«</li>
        `,
        `
        <li class='w3-text-black'><b>Diese Klasse wird im CANSpiN-Projekt seit CS1 v1.1.0 nicht mehr berücksichtigt.</b></li>
        <li><i>UE</i> steht für <i>Übertragung</i>.</li>
  ...
  'english_lang': {
    ...
    'annotation_classes_infos': [
      [
        ...
        `,
        `
        <li><i>ALT</i> stands for <i>alternative usage</i>.</li>
        <li>It marks an expression that cannot be annotated according to the main classes at this point in the text, but which can be annotated elsewhere, i.e. the expression can have a spatial meaning according to the main classes.</li>
        <li>The expression or the head of the compound must in contemporary language usage (referring to a dictionary like <a href='https://www.dwds.de/wb' target='_blank'>DWDS</a>)) be able to be used spatially in the sense of a place, i.e. as a designation for a container, a geographical, astronomical or space-structual object or abstractum.</li>
        <li>»She got lost in <span class='inline-examples'>her <span class='w3-tag'>mind palace</span></span>.«</li>
        <li>»Have the people from Berlin contacted you yet? - <span class='inline-examples'>Yes, <span class='w3-tag'>Berlin</span></span> has canceled the contract.«</li>
        <li>»A favorable coincidence led on <span class='inline-examples'>this <span class='w3-tag'>track</span></span> to the book I was looking for.«</li>
        <li>»the <span class='inline-examples'>Flavian <span class='w3-tag'>imperial house</span></span>«.</li>
        <li>»she makes <span class='inline-examples'>a <span class='w3-tag'>side path</span></span> to the library«.</li>
        `,
        `
        ...
        <li>The transferred use can be creative-metaphorical: »She got lost in <span class='inline-examples'>her <span class='w3-tag w3-grey w3-text-grey'>mind palace</span></span>.«</li>
        <li>It can be creative-metonymic: »Have the people from Berlin contacted you yet? - <span class='inline-examples'>Yes, <span class='w3-tag w3-grey w3-text-grey'>Berlin</span></span> has canceled the contract.«</li>
        <li>It can be idiomatic-metaphorical: »A favorable coincidence led on <span class='inline-examples'>this <span class='w3-tag w3-grey w3-text-grey'>track</span></span> to the book I was looking for.«</li>
        <li>It can be idiomatic-metonymic: »the <span class='inline-examples'>Flavian <span class='w3-tag w3-grey w3-text-grey'>imperial house</span></span>«.</li>
        `,
        `
        <li class='w3-text-black'><b>This class is no longer taken into account in the CANSpiN project since CS1 v1.1.0.</b></li>
        <li><i>T</i> stands for <i>Transferred use</i>.</li>
      ...
      [
        ...
        <li><i>ALT</i> stands for <i>alternative usage</i>.</li>
        <li>It marks an expression that cannot be annotated according to the main classes at this point in the text, but which can be annotated elsewhere, i.e. the expression can have a spatial meaning according to the main classes.</li>
        <li>The expression must in contemporary language usage (referring to a dictionary like <a href='https://www.dwds.de/wb' target='_blank'>DWDS</a>)) be able to be used spatially in the sense of a movement, i.e. as a designation for a movement of subjects, objects, light, sound and smell, or their perception.</li>
        <li>»The <span class='inline-examples'>moon <span class='w3-tag'>sang</span></span> me the song of my childhood.«</li>
        <li>»The <span class='inline-examples'>sight <span class='w3-tag'>brought back</span></span> memories of the situation at the time.«</li>
        <li>»<span class='inline-examples'>That <span class='w3-tag'>sounds</span></span> like the title of an action movie.«</li>
        <li>»This <span class='inline-examples'>road <span class='w3-tag'>leads</span></span> to the city gates.«</li>
        `,
        `
        <li class='w3-text-white'><b>This class is no longer taken into account in the CANSpiN project since CS1 v1.1.0.</b></li>
        <li><i>T</i> stands for <i>Transferred use</i>.</li>
        <li><i>T-SpX</i> is a transferred use of spatial vocabulary (spatial source domain: Sp) to express non-spatial issues (non-spatial target domain: X).</li>
        <li>The transferred use can be creative-metaphorical: »The <span class='inline-examples'>moon <span class='w3-tag w3-grey w3-text-grey'>sang</span></span> me the song of my childhood.«</li>
        <li>It can be idiomatic-metaphorical: »The <span class='inline-examples'>sight <span class='w3-tag w3-grey w3-text-grey'>brought back</span></span> memories of the situation at the time.«</li>
        <li>It can be idiomatic-metonymic: »<span class='inline-examples'>That <span class='w3-tag w3-grey w3-text-grey'>sounds</span></span> like the title of an action movie.«</li>
        `,
        `
        <li class='w3-text-white'><b>This class is no longer taken into account in the CANSpiN project since CS1 v1.1.0.</b></li>
        <li><i>T</i> stands for <i>Transferred use</i>.</li>
      ...
      [
        ...
        <li><i>ALT</i> stands for <i>alternative usage</i>.</li>
        <li>It marks an expression that cannot be annotated according to the main classes at this point in the text, but which can be annotated elsewhere, i.e. the expression can have a spatial meaning according to the main classes.</li>
        <li>The expression must in contemporary language usage (referring to a dictionary like <a href='https://www.dwds.de/wb' target='_blank'>DWDS</a>)) be able to be used spatially in the sense of a dimensioning, i.e. as a designation for size or extend of spatial entities or distances.</li>
        <li>In contrast to size and distance specifications, quantity specifications only work spatially with reference to a spatial entity: if a quantity specification refers to something non-spatial, this is not annotated as an alternative usage.</li>
        <li>»That <span class='inline-examples'>was <span class='w3-tag'>highly</span></span> unpleasant news.«</li>
        `,
        `
        <li class='w3-text-black'><b>This class is no longer taken into account in the CANSpiN project since CS1 v1.1.0.</b></li>
        <li><i>T</i> stands for <i>Transferred use</i>.</li>
        ...
        <li>The transferred use can be idiomatic-metaphorical: »That <span class='inline-examples'>was <span class='w3-tag w3-grey w3-text-grey'>highly</span></span> unpleasant news.«</li>
        `,
        `
        <li class='w3-text-black'><b>This class is no longer taken into account in the CANSpiN project since CS1 v1.1.0.</b></li>
        <li><i>T</i> stands for <i>Transferred use</i>.</li>
      ...
      [
        ...
        <li><i>ALT</i> stands for <i>alternative usage</i>.</li>
        <li>It marks an expression that cannot be annotated according to the main classes at this point in the text, but which can be annotated elsewhere, i.e. the expression can have a spatial meaning according to the main classes.</li>
        <li>The expression must be part of a phrase involving content words of the categories place, movement or dimensioning, which are used alternatively in the phrase.</li>
        <li>»<span class='inline-examples'><b>shatter</b> <span class='w3-tag'>on</span></span> the silver shield of truth«.</li>
        <li>»some sorrow <span class='inline-examples'><b>gnaws</b> <span class='w3-tag'>at</span></span> the heart«.</li>
        `,
        `
        <li class='w3-text-black'><b>This class is no longer taken into account in the CANSpiN project since CS1 v1.1.0.</b></li>
        <li><i>T</i> stands for <i>Transferred use</i>.</li>
        <li><i>T-SpX</i> is a transferred use of spatial vocabulary (spatial source domain: Sp) to express non-spatial issues (non-spatial target domain: X).</li>
        <li>The expression must be part of a transferred usage phrase involving content words of the categories place, movement or dimensioning, or must have developed etymologically from a spatial use.</li>
        <li>The transferred use can be idiomatic-metaphorical: »<span class='inline-examples'><b>shatter</b> <span class='w3-tag w3-grey w3-text-grey'>on</span></span> the silver shield of truth«, »some sorrow <span class='inline-examples'><b>gnaws</b> <span class='w3-tag'>at</span></span> the heart«.</li>
        `,
        `
        <li class='w3-text-black'><b>This class is no longer taken into account in the CANSpiN project since CS1 v1.1.0.</b></li>
        <li><i>T</i> stands for <i>Transferred use</i>.</li>
      ...
      [
        ...
        <li>It marks an expression that cannot be annotated according to the main classes at this point in the text, but which can be annotated elsewhere, i.e. the expression can have a spatial meaning according to the main classes.</li>
        <li>The expression must be part of a phrase involving content words of the categories place, movement or dimensioning, which are used alternatively in the phrase.</li>
        <li>»Sometimes you can <span class='inline-examples'><b>get</b> <span class='w3-tag'>out of</span></span> rhythm.«</li>
        <li>»This road <span class='inline-examples'><b>leads</b> <span class='w3-tag'>to</span></span> the city gates.«</li></li>
        `,
        `
        <li class='w3-text-black'><b>This class is no longer taken into account in the CANSpiN project since CS1 v1.1.0.</b></li>
        <li><i>T</i> stands for <i>Transferred use</i>.</li>
        <li><i>T-SpX</i> is a transferred use of spatial vocabulary (spatial source domain: Sp) to express non-spatial issues (non-spatial target domain: X).</li>
        <li>The expression must be part of a transferred usage phrase involving content words of the categories place, movement or dimensioning, or must have developed etymologically from a spatial use.</li>
        <li>The transferred use can be idiomatic-metaphorical: »Sometimes you can <span class='inline-examples'><b>get</b> <span class='w3-tag w3-grey w3-text-grey'>out of</span></span> rhythm.«</li>
        `,
        `
        <li class='w3-text-black'><b>This class is no longer taken into account in the CANSpiN project since CS1 v1.1.0.</b></li>
        <li><i>T</i> stands for <i>Transferred use</i>.</li>
...
const startLanguageCode = 'german_lang';

function setContentInLanguage(languageCode) {
  // main
  // - language attribute of main
  [...document.getElementsByTagName('main')][0].setAttribute('lang', languageDict[languageCode]['main']);
  // - h2 headings in categories and example
  document.querySelector('div[data-id="categories"] > h2').textContent = languageDict[languageCode]['h2_headings']['categories'];
  document.querySelector('div[data-id="example"] > h2').textContent = languageDict[languageCode]['h2_headings']['example'];
  ...
  for (const [headingIndex, heading] of h3_headings.entries()) {
    const _categorieNames = languageDict[languageCode]['annotation_categories'];
  ...
  for (const [accordionPanelIndex, accordionPanel] of accordionPanels.entries()) {
    accordionPanel.children[0].innerHTML = languageDict[languageCode]['accordion_initial_examples'][accordionPanelIndex];
  }
  ...
  for (const accordionPanel of accordionPanels) {
    ...
    for (const [headingIndex, heading] of h4_headings.entries()) {
      const _accordionPanelHeadings = languageDict[languageCode]['h4_headings'];
  ...
  for (const [accordionPanelIndex, accordionPanel] of accordionPanels.entries()) {
    ...
    for (const [annotationClassTagIndex, annotationClassTag] of annotationClassTags.entries()) {
      annotationClassTag.textContent = languageDict[languageCode]['annotation_classes'][accordionPanelIndex][annotationClassTagIndex];
    }
  }
  // - grammatical indicators in categories > accordion > accordion-panel
  for (const [accordionPanelIndex, accordionPanel] of accordionPanels.entries()) {
    accordionPanel.querySelector('.grammaticalIndicator').innerHTML = languageDict[languageCode]['grammaticalIndicators'][accordionPanelIndex];
  }
  ...
  for (const accordionPanel of accordionPanels) {
    ...
    for (const placeholder of placeholders) {
      placeholder.textContent = languageDict[languageCode]['placeholder'];
    }
  }
  ...
  for (const [accordionPanelIndex, accordionPanel] of accordionPanels.entries()) {
    ...
    for (const [headingIndex, heading] of h5_headings.entries()) {
      const _classInfoHeadings = languageDict[languageCode]['annotation_classes'][accordionPanelIndex];
  ...
  for (const [accordionPanelIndex, accordionPanel] of accordionPanels.entries()) {
    ...
    for (const [annotationClassInfosIndex, annotationClassInfos] of annotationClassesInfos.entries()) {
      annotationClassInfos.innerHTML = languageDict[languageCode]['annotation_classes_infos'][accordionPanelIndex][annotationClassInfosIndex];
    }
  }
  ...
  for (const [beispieltextBtnIndex, beispieltextBtn] of beispieltextBtns.entries()) {
    beispieltextBtn.textContent = languageDict[languageCode]['annotation_categories'][beispieltextBtnIndex];
  }
  ...
  beispieltextTexts[0].innerHTML = languageDict[languageCode]['example_text'];

  // footer
  [...document.getElementsByTagName('footer')][0].innerHTML = languageDict[languageCode]['footer'];
}

function refreshBeispieltextDisplay() {
  // sets display depending on settings saved in exampleSettings object
...
function addEventListener_languageSelect() {
  ...
  for (const btn of languageButtonsList) {
    btn.addEventListener('click', function(e) {
      ...
      const otherLanguageButtons = [...clickedLanguageButton.parentElement.children].filter(child => child !== clickedLanguageButton);
      otherLanguageButtons.forEach(element => element.classList.remove('active'));
      clickedLanguageButton.classList.add('active');

      // set content in language
      setContentInLanguage(clickedLanguageButton.id)

      // refresh example text display
      refreshBeispieltextDisplay();
